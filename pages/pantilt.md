...
Exécutez `learn_example.py`, lisez son code ainsi que celui de `mlp.py` et répondez aux quesitons suivantes. Dans le rendu, vous écrirez vos réponses dans le fichier `README.md`.
